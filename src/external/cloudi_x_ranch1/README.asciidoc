...
* http://ninenines.eu/docs/en/ranch1/1.3/guide[User guide]
* http://ninenines.eu/docs/en/ranch1/1.3/manual[Function reference]
...
* https://github.com/ninenines/ranch1/issues[Issues tracker]
