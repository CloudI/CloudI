...
listen(Opts) ->
	...
	Opts3 = ranch1:set_option_default(Opts2, nodelay, true),
	Opts4 = ranch1:set_option_default(Opts3, send_timeout, 30000),
	Opts5 = ranch1:set_option_default(Opts4, send_timeout_close, true),
	%% We set the port to 0 because it is given in the Opts directly.
	%% The port in the options takes precedence over the one in the
	%% first argument.
	gen_tcp:listen(0, ranch1:filter_options(Opts5, disallowed_listen_options(),
