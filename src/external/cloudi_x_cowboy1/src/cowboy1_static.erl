...
-spec init(_, _, _) -> {upgrade, protocol, cowboy1_rest}.
init(_, _, _) ->
	{upgrade, protocol, cowboy1_rest}.
...
rest_init_dir(Req, Path, HowToAccess, Extra) ->
	...
	{PathInfo, Req2} = cowboy1_req:path_info(Req),
...
fullpath_test_() ->
	Tests = [
		{<<"/home/cowboy1">>, <<"/home/cowboy1">>},
		{<<"/home/cowboy1">>, <<"/home/cowboy1/">>},
		{<<"/home/cowboy1">>, <<"/home/cowboy1/./">>},
		{<<"/home/cowboy1">>, <<"/home/cowboy1/./././././.">>},
		{<<"/home/cowboy1">>, <<"/home/cowboy1/abc/..">>},
		{<<"/home/cowboy1">>, <<"/home/cowboy1/abc/../">>},
		{<<"/home/cowboy1">>, <<"/home/cowboy1/abc/./../.">>},
		{<<"/">>, <<"/home/cowboy1/../../../../../..">>},
		{<<"/etc/passwd">>, <<"/home/cowboy1/../../etc/passwd">>}
	],
...
good_path_check_test_() ->
	Tests = [
		...
		<<"/home/cowboy1/./file">>,
		<<"/home/cowboy1/././././././file">>,
		<<"/home/cowboy1/abc/../file">>,
		<<"/home/cowboy1/abc/../file">>,
		<<"/home/cowboy1/abc/./.././file">>
	],
	[{P, fun() ->
		case fullpath(P) of
			<< "/home/cowboy1/", _/binary >> -> ok
		end
	end} || P <- Tests].
...
bad_path_win32_check_test_() ->
	Tests = case os:type() of
		...
		{win32, _} ->
			[
				<<"c:/home/cowboy1/../../secretfile.bat">>,
				<<"c:/home/cowboy1/c:/secretfile.bat">>,
				<<"c:/home/cowboy1/..\\..\\secretfile.bat">>,
				<<"c:/home/cowboy1/c:\\secretfile.bat">>
			]
	end,
...
content_types_provided(Req, State={Path, _, Extra}) ->
	case lists:keyfind(mimetypes, 1, Extra) of
		false ->
			{[{cow1_mimetypes:web(Path), get_file}], Req, State};
...
%% Stream the file.
%% @todo Export cowboy1_req:resp_body_fun()?
