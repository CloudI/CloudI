...
uts46_map(CP) when 2238 =< CP, CP =< 2258 -> 'X';
...
uts46_map(CP) when 2894 =< CP, CP =< 2901 -> 'X';
...
uts46_map(CP) when 3184 =< CP, CP =< 3191 -> 'X';
...
uts46_map(CP) when 3456 =< CP, CP =< 3457 -> 'X';
...
uts46_map(CP) when 3717 =< CP, CP =< 3718 -> 'X';
uts46_map(CP) when 3719 =< CP, CP =< 3720 -> 'V';
uts46_map(CP) when 3723 =< CP, CP =< 3724 -> 'X';
uts46_map(CP) when 3726 =< CP, CP =< 3731 -> 'X';
uts46_map(CP) when 3732 =< CP, CP =< 3735 -> 'V';
uts46_map(CP) when 3737 =< CP, CP =< 3743 -> 'V';
uts46_map(CP) when 3745 =< CP, CP =< 3747 -> 'V';
uts46_map(CP) when 3752 =< CP, CP =< 3753 -> 'X';
...
uts46_map(CP) when 6847 =< CP, CP =< 6911 -> 'X';
...
uts46_map(CP) when 7312 =< CP, CP =< 7354 -> 'X';
uts46_map(CP) when 7355 =< CP, CP =< 7356 -> 'X';
uts46_map(CP) when 7357 =< CP, CP =< 7359 -> 'X';
...
uts46_map(CP) when 7418 =< CP, CP =< 7423 -> 'X';
...
uts46_map(CP) when 11158 =< CP, CP =< 11159 -> 'X';
...
uts46_map(CP) when 11855 =< CP, CP =< 11903 -> 'X';
...
uts46_map(CP) when 12731 =< CP, CP =< 12735 -> 'X';
...
uts46_map(CP) when 19894 =< CP, CP =< 19903 -> 'X';
...
uts46_map(CP) when 40944 =< CP, CP =< 40959 -> 'X';
...
uts46_map(CP) when 43878 =< CP, CP =< 43887 -> 'X';
...
uts46_map(CP) when 65948 =< CP, CP =< 65951 -> 'X';
...
uts46_map(CP) when 69247 =< CP, CP =< 69375 -> 'X';
...
uts46_map(CP) when 69466 =< CP, CP =< 69631 -> 'X';
...
uts46_map(CP) when 69959 =< CP, CP =< 69967 -> 'X';
...
uts46_map(CP) when 70094 =< CP, CP =< 70095 -> 'X';
...
uts46_map(CP) when 70751 =< CP, CP =< 70783 -> 'X';
...
uts46_map(CP) when 71352 =< CP, CP =< 71359 -> 'X';
...
uts46_map(CP) when 71936 =< CP, CP =< 72191 -> 'X';
...
uts46_map(CP) when 72324 =< CP, CP =< 72325 -> 'X';
...
uts46_map(CP) when 73465 =< CP, CP =< 73727 -> 'X';
...
uts46_map(CP) when 78895 =< CP, CP =< 82943 -> 'X';
...
uts46_map(CP) when 93760 =< CP, CP =< 93791 -> 'X';
...
uts46_map(CP) when 122923 =< CP, CP =< 124927 -> 'X';
...
uts46_map(CP) when 125259 =< CP, CP =< 125263 -> 'X';
...
uts46_map(CP) when 126133 =< CP, CP =< 126463 -> 'X';
...
uts46_map(CP) when 127405 =< CP, CP =< 127461 -> 'X';
...
uts46_map(CP) when 128725 =< CP, CP =< 128735 -> 'X';
...
uts46_map(CP) when 128762 =< CP, CP =< 128767 -> 'X';
...
uts46_map(CP) when 128985 =< CP, CP =< 129023 -> 'X';
...
uts46_map(CP) when 129198 =< CP, CP =< 129279 -> 'X';
uts46_map(CP) when 129280 =< CP, CP =< 129291 -> 'V';
uts46_map(CP) when 129292 =< CP, CP =< 129295 -> 'X';
...
uts46_map(CP) when 129393 =< CP, CP =< 129394 -> 'X';
uts46_map(CP) when 129395 =< CP, CP =< 129398 -> 'V';
uts46_map(CP) when 129399 =< CP, CP =< 129401 -> 'X';
...
uts46_map(CP) when 196608 =< CP, CP =< 262141 -> 'X';
